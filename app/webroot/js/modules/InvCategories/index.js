/* (c)Bittion | Created: 12/10/2014 | Developer:reyro | JS: InvCategories/index */
jQuery(document).ready(function() {
//START SCRIPT
//************************************** EXEC MAIN - START **************************************
//    Created: 12/10/2014 | Developer: reyro | Description: initiate DataTable
    var table1 = jQuery('#InvCategoryIndexDT').DataTable({
        /////////Ajax
        'bServerSide': true
...
//    Created: 12/10/2014 | Developer: reyro | Description: generates Html Row Buttons Edit and Delete
	...
	var buttonHtml = '<a href="' + bittionUrlProjectAndController + 'save/id:' + id + '" class="btn btn-primary btn-sm" title="Editar"><i class="fa fa-pencil"></i></a>';
        buttonHtml += ' <button type="button" id="delete-' + id + '" class="btn btn-danger btnDelete btn-sm" title="Eliminar"><i class="fa fa-trash-o"></i></button>';
        return buttonHtml;
    }
	
//    Created: 12/10/2014 | Developer: reyro | Description: bind events to DataTable Html Controls
...
//    Created: 12/10/2014 | Developer: reyro | Description: deletes | Request:Ajax
