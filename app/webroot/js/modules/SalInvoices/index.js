/* (c)Bittion | Created: 17/10/2014 | Developer:reyro | JS: SalInvoices/index */
jQuery(document).ready(function() {
//START SCRIPT
//************************************** EXEC MAIN - START **************************************
//    Created: 17/10/2014 | Developer: reyro | Description: initiate DataTable
    var table1 = jQuery('#SalInvoiceIndexDT').DataTable({
        /////////Ajax
        'bServerSide': true
        ...
        , 'fnCreatedRow': function(nRow, aData, iDataIndex) {
            var htmlTableButtons = fnGenerateHtmlTableButtons(aData[5]);
            ...
            jQuery('td:eq(4)', nRow).html(active);
        }
...
//    Created: 17/10/2014 | Developer: reyro | Description: generates Html Row Buttons Edit and Delete
...
//    Created: 17/10/2014 | Developer: reyro | Description: bind events to DataTable Html Controls
...
//    Created: 17/10/2014 | Developer: reyro | Description: deletes | Request:Ajax
