/* (c)Bittion Admin Module | Created: 14/08/2014 | Developer:reyro | JS: AdmModules/index */
jQuery(document).ready(function() {
//START SCRIPT
//************************************** EXEC MAIN - START **************************************
//    Created: 14/08/2014 | Developer: reyro | Description: initiate DataTable
    var table1 = jQuery('#AdmModuleIndexDT').DataTable({
        /////////Ajax
        'bServerSide': true
...
//    Created: 14/08/2014 | Developer: reyro | Description: generates Html Row Buttons Edit and Delete
...
//    Created: 14/08/2014 | Developer: reyro | Description: bind events to DataTable Html Controls
...
//    Created: 14/08/2014 | Developer: reyro | Description: restores logic deleted users | Request:Ajax
