/* (c)Bittion | Created: 07/06/2015 | Developer:reyro | JS: SalProposals/index */
jQuery(document).ready(function() {
//START SCRIPT
//************************************** EXEC MAIN - START **************************************
//    Created: 07/06/2015 | Developer: reyro | Description: initiate DataTable
    var table1 = jQuery('#SalProposalIndexDT').DataTable({
        /////////Ajax
        'bServerSide': true
...
//    Created: 07/06/2015 | Developer: reyro | Description: deletes | Request:Ajax
