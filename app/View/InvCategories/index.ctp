<?php /* (c)Bittion | Created: 12/10/2014 | Developer:reyro | View: InvCategories/index */ ?>
<!-- ------------------ START VIEW JS ------------------ -->
...
<?php echo $this->Html->script('modules/InvCategories/index', FALSE); ?> 
<!-- ------------------ END VIEW JS -------------------- -->
...
<?php echo $this->element('SmartWidgetContentStart', array('title' => 'Categorias', 'icon' => '<i class="fa fa-table"></i>')); ?>
<!-- ------------------ START CONTENT ------------------ -->
<table id="InvCategoryIndexDT" class="table table-striped table-bordered table-hover table-condensed" width="100%">
    <thead>
        <tr>
            <th>Nombre</th>
            <th>Descripción</th>
