<?php /* (c)Bittion | Created: 15/01/2015 | Developer:reyro | View: SalOffices/index */ ?>
<!-- ------------------ START VIEW JS ------------------ -->
...
<?php echo $this->Html->script('modules/SalOffices/index', FALSE); ?> 
<!-- ------------------ END VIEW JS -------------------- -->
...
<?php echo $this->element('SmartWidgetContentStart', array('title' => 'Sucursales', 'icon' => '<i class="fa fa-table"></i>')); ?>
<!-- ------------------ START CONTENT ------------------ -->
<table id="SalOfficeIndexDT" class="table table-striped table-bordered table-hover table-condensed" width="100%">
    <thead>
        <tr>
            <th>Nombre</th>
            <th>Dirección</th>
