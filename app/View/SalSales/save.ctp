<?php /* (c)Bittion | Created: 07/10/2014 | Developer:reyro | View: SalSales/save | Description: create and update */ ?>
<!-- ------------------ START VIEW JS ------------------ -->
...
<?php echo $this->Html->script('modules/SalSales/save', FALSE); ?>
<!-- ------------------ END VIEW JS -------------------- -->
...
<!--<div id="documentButtons">
    <button class="btn btn-default" id="btnCancel" type="submit">Volver</button>
    <button class="btn btn-primary" id="btnSave" type="submit">Guardar</button>
    <button class="btn btn-success" id="btnSale" type="submit">Vender</button>
    <button class="btn btn-danger" id="btnSale" type="submit">Cancelar</button>
</div>-->
...
<!--<div style="padding: 1px 1px 1px;">
    <button class="btn btn-primary" id="btnSave" type="submit">Guardar</button><a href="/progreso/SalSales" class="btn btn-default" id="btnCancel"> Volver</a>
</div>-->
...
<footer>
    ...
    <?php echo $this->Html->link('<i class="fa fa-table"></i> Ver Ventas', array('action' => 'index'), array('class' => 'btn bg-color-blueDark txt-color-white', 'escape' => false, 'id' => 'btnView')); ?>
</footer>
